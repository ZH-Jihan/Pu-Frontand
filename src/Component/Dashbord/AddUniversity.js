...
const AddUniversity = () => {
    const handleProgram = (event) => {
        ...
        fetch("https://pu-server-1.onrender.com/api/v1/university", {
          method: "POST",
          headers: {
          ...
          <div class="grid  gap-8 grid-cols-1">
            <div class="flex flex-col ">
              <div class="flex flex-col sm:flex-row items-center">
                <h2 class="font-semibold text-3xl mr-auto">Add University List</h2>
                ...
                <div class="form">
                  ...
                  <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                    <div class="form-control  mb-3 space-y-2 w-full text-base">
                      ...
                      University Name<span title="required" className='text-red-500'>*</span>
                      </label>
                      <input
                    ...
                    <div class="form-control  mb-3 space-y-2 w-full text-base">
                      <label class="font-semibold text-gray-600 text-xl py-2">
                      University ID<span title="required" className='text-red-500'>*</span>
                      </label>
                      <input
